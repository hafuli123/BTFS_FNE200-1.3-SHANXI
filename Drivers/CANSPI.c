...
/* CAN通信初始化  */
uint8_t CANSPI_Initialize(uint32_t baudrate)
{	
  RXF0 RXF0reg;
  RXF1 RXF1reg;
  RXF2 RXF2reg;
  ...
  */
	...
	case 125000:
		MCP2515_WriteByte(MCP2515_CNF1, 0x03);
		MCP2515_WriteByte(MCP2515_CNF2, 0xBA);
	...
	case 1000000:
		MCP2515_WriteByte(MCP2515_CNF1, 0x00);
		MCP2515_WriteByte(MCP2515_CNF2, 0x98);
