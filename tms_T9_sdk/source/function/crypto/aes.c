...
unsigned char flag_aes;
static unsigned char init_mode;

int tms_aes_genkey(unsigned short keyid, unsigned int aes_bit_len)
{
    int rv = SUCCEED;
    TRANSMIT_DATA apdu;
...
int tms_aes_import_key(unsigned char *keyval, unsigned int key_len, unsigned short keyid)
{
    int rv = SUCCEED;
    TRANSMIT_DATA apdu;
    unsigned char buf[APDU_BUFFER_MAX_SIZE] = {0};
    ...
    if ((key_len != SYM_BLOCK_LEN) && (key_len != (SYM_BLOCK_LEN * 2))) {
...
int tms_aes_init_ext(unsigned char *key_val, unsigned int key_len,
...
int tms_aes_init(unsigned short keyid, unsigned char *iv_val, unsigned int iv_len, unsigned int enc)
{
    int rv = SUCCEED;
    TRANSMIT_DATA apdu;
    unsigned char buf[APDU_BUFFER_MAX_SIZE] = {0};
...
int tms_aes_update(unsigned char * indata, unsigned int indata_len, 
...
int tms_aes_final(unsigned char *indata, unsigned int indata_len,
                                unsigned char *outdata, unsigned int *outdata_len)
{
    int rv = SUCCEED;
    TRANSMIT_DATA apdu;
